#ifndef __TEST_BATTERY_STATUS__
#define __TEST_BATTERY_STATUS__
...
/**
 * @ingroup Devices
 * @brief TestBatteryStatus
 */
class TestBatteryStatus : public yarp::dev::DeviceDriver,
